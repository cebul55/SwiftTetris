...
class Shape : Hashable , CustomStringConvertible {
    ...
    final func rotateShape(orientation: Orientation) {
        
        guard let blockRowColumnTranslation: Array<(columnDiff: Int, rowDiff: Int)> = blockRowColumnPosition[orientation]
            else {
                    return
        }
    ...
    final func rotateClockwise() {
        ...
        rotateShape(orientation: newOrientation)
    ...
    final func moveTo(column: Int, row: Int){
        ...
        self.column = column
        self.row    = row
        rotateShape(orientation: orientation)
